...
//No geral, o programa é simples. Ele declara uma função main, que é o ponto de entrada do programa. Dentro dessa função, 
//duas mensagens são impressas no console, uma após a outra. 